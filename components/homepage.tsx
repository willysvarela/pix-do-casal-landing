  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center justify-between px-10">
          ...
          <nav className="flex items-center gap-4">
            <ThemeToggle />
            <Link href="https://instagram.com/pixdocasal.app" target="_blank" rel="noopener noreferrer">
              <Instagram className="h-5 w-5" />
              <span className="sr-only">Instagram</span>
            </Link>
            <Link href="https://tiktok.com/@pixdocasal.app" target="_blank" rel="noopener noreferrer">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="container space-y-6 py-12 text-center md:py-24 lg:py-32 animate-fade-up px-10">
        ...
        {/* No Taxes Section */}
        <section className="container py-12 md:py-24 lg:py-32 relative overflow-hidden px-10">
        ...
        <section id="waitlist" className="container py-12 md:py-24 lg:py-32 bg-muted px-10">
